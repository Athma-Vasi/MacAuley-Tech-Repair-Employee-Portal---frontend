import type { QueryResponseData, SetPageInErrorPayload } from "../../types";
import type { SortDirection } from "../query/types";
import { type ResourceAction, resourceAction } from "./actions";
import type { LimitPerPage, ResourceDispatch, ResourceState } from "./types";
...
function resourceReducer_setResourceData(
  ...
  return {
    ...state,
    resourceData: dispatch.payload as Array<QueryResponseData>,
  };
}
...
function resourceReducer_setSortField(
  ...
  const sortedData = clonedData.sort(
    (a: QueryResponseData, b: QueryResponseData) => {
