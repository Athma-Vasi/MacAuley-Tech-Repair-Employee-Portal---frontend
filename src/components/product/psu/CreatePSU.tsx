...
function CreatePsu({
  ...
  }, [createProductAction.setIsPsuWattageValid, createProductDispatch, psuWattage]);
  ...
  // ╰─────────────────────────────────────────────────────────────────╯
  const [createdPsuEfficiencyRatingSelectInput] = returnAccessibleSelectInputElements([
    {
  ...
  // ╰─────────────────────────────────────────────────────────────────╯
  const [createdAddPsuFieldsAdditionalMapButton] = returnAccessibleButtonElements([
    {
      buttonLabel: "Add",
  ...
  const psuFieldsAdditionalMapKeysErrorValidTextElements: [JSX.Element, JSX.Element][] =
    Array.from(psuFieldsAdditionalMap).map((keyFieldValue) => {
      ...
      const [
        ...
        inputText: field,
        isInputTextFocused: arePsuFieldsAdditionalMapFocused.get(mapKey)?.[0] ?? false,
        isValidInputText: arePsuFieldsAdditionalMapValid.get(mapKey)?.[0] ?? false,
  ...
  const psuFieldsAdditionalMapValuesErrorValidTextElements: [JSX.Element, JSX.Element][] =
    Array.from(psuFieldsAdditionalMap).map((keyFieldValue) => {
      ...
      const [
        ...
        inputText: value,
        isInputTextFocused: arePsuFieldsAdditionalMapFocused.get(mapKey)?.[1] ?? false,
        isValidInputText: arePsuFieldsAdditionalMapValid.get(mapKey)?.[1] ?? false,
    ...
    return (
      <Stack key={`psuFieldsAdditionalMap-${mapKey}`} pt={padding} w="100%">
        <Group position="apart">
          <Text size="md" weight={600}>{`Additional PSU field ${mapKey + 1}`}</Text>
          {displayDeleteButton}
        </Group>
        <Group position="apart">
          {createdPsuFieldsAdditionalMapKeysTextAreaInput}
  ...
  const displayPsuFieldsAdditionalMapButton = (
    <Tooltip label={`Add additional PSU field ${psuFieldsAdditionalMap.size + 1}`}>
