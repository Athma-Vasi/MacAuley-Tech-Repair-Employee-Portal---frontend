...
function CreateCpu({
  ...
  }, [cpuSocket, createProductAction.setIsCpuSocketValid, createProductDispatch]);
  ...
  }, [cpuFrequency, createProductAction.setIsCpuFrequencyValid, createProductDispatch]);
  ...
  }, [cpuWattage, createProductAction.setIsCpuWattageValid, createProductDispatch]);
  ...
  // screenreader accessible text input element
  const [createdCpuL1CacheCapacityTextInput] = returnAccessibleTextInputElements([
    {
      description: {
  ...
  // ╰─────────────────────────────────────────────────────────────────╯
  const [createdCpuL1CacheCapacityUnitSelectInput] = returnAccessibleSelectInputElements([
    {
  ...
  // screenreader accessible text input element
  const [createdCpuL2CacheCapacityTextInput] = returnAccessibleTextInputElements([
    {
      description: {
  ...
  // ╰─────────────────────────────────────────────────────────────────╯
  const [createdCpuL2CacheCapacityUnitSelectInput] = returnAccessibleSelectInputElements([
    {
      data: MEMORY_UNIT_SELECT_INPUT_DATA,
      description: "",
  ...
  // screenreader accessible text input element
  const [createdCpuL3CacheCapacityTextInput] = returnAccessibleTextInputElements([
    {
      description: {
  ...
  // ╰─────────────────────────────────────────────────────────────────╯
  const [createdCpuL3CacheCapacityUnitSelectInput] = returnAccessibleSelectInputElements([
    {
      data: MEMORY_UNIT_SELECT_INPUT_DATA,
      description: "",
  ...
  // ╰─────────────────────────────────────────────────────────────────╯
  const [createdAddCpuFieldsAdditionalMapButton] = returnAccessibleButtonElements([
    {
      buttonLabel: "Add",
  ...
  const cpuFieldsAdditionalMapKeysErrorValidTextElements: [JSX.Element, JSX.Element][] =
    Array.from(cpuFieldsAdditionalMap).map((keyFieldValue) => {
      ...
      const [
        ...
        inputText: field,
        isInputTextFocused: areCpuFieldsAdditionalMapFocused.get(mapKey)?.[0] ?? false,
        isValidInputText: areCpuFieldsAdditionalMapValid.get(mapKey)?.[0] ?? false,
  ...
  const cpuFieldsAdditionalMapValuesErrorValidTextElements: [JSX.Element, JSX.Element][] =
    Array.from(cpuFieldsAdditionalMap).map((keyFieldValue) => {
      ...
      const [
        ...
        inputText: value,
        isInputTextFocused: areCpuFieldsAdditionalMapFocused.get(mapKey)?.[1] ?? false,
        isValidInputText: areCpuFieldsAdditionalMapValid.get(mapKey)?.[1] ?? false,
    ...
    return (
      <Stack key={`cpuFieldsAdditionalMap-${mapKey}`} pt={padding} w="100%">
        <Group position="apart">
          <Text size="md" weight={600}>{`Additional CPU field ${mapKey + 1}`}</Text>
          {displayDeleteButton}
        </Group>
        <Group position="apart">
          {createdCpuFieldsAdditionalMapKeysTextAreaInput}
  ...
  const displayCpuFieldsAdditionalMapButton = (
    <Tooltip label={`Add additional CPU field ${cpuFieldsAdditionalMap.size + 1}`}>
