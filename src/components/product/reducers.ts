...
function setAreAccessoryFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      Array.from(areAccessoryFieldsAdditionalMapFocusedClone).forEach(
        (mapIdxKeyVal, arrayIdx) => {
          const [_mapIdx, keyVal] = mapIdxKeyVal as [number, [boolean, boolean]];
    ...
    case "update": {
      ...
      const { data, index, kind } = action.payload as AdditionalFieldsValidFocusedUpdate;
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areAccessoryFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
        : areAccessoryFieldsAdditionalMapFocusedClone.set(index, [prevKey, data]);
...
function setAreAccessoryFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areAccessoryFieldsAdditionalMapValid: areAccessoryFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areAccessoryFieldsAdditionalMapValidClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areAccessoryFieldsAdditionalMapValidClone.set(index, [data, prevValue])
...
function setAreCpuFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      return {
        ...state,
        areCpuFieldsAdditionalMapFocused: filteredAreCpuFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const areCpuFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreCaseFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areCaseFieldsAdditionalMapFocused: areCaseFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areCaseFieldsAdditionalMapFocusedClone = structuredClone(
      ...
      return {
        ...state,
        areCaseFieldsAdditionalMapFocused: filteredAreCaseFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const areCaseFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreCaseFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      return {
        ...state,
        areCaseFieldsAdditionalMapValid: filteredAreCaseFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areCaseFieldsAdditionalMapValidClone = structuredClone(
...
function setAreDisplayFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areDisplayFieldsAdditionalMapFocused: areDisplayFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areDisplayFieldsAdditionalMapFocusedClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areDisplayFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
...
function setAreDisplayFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areDisplayFieldsAdditionalMapValid: areDisplayFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areDisplayFieldsAdditionalMapValidClone = structuredClone(
      ...
      return {
        ...state,
        areDisplayFieldsAdditionalMapValid: filteredAreDisplayFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areDisplayFieldsAdditionalMapValidClone = structuredClone(
...
function setAreGpuFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      return {
        ...state,
        areGpuFieldsAdditionalMapFocused: filteredAreGpuFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const areGpuFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreHeadphoneFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areHeadphoneFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
        : areHeadphoneFieldsAdditionalMapFocusedClone.set(index, [prevKey, data]);
...
function setAreHeadphoneFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areHeadphoneFieldsAdditionalMapValid: areHeadphoneFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areHeadphoneFieldsAdditionalMapValidClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areHeadphoneFieldsAdditionalMapValidClone.set(index, [data, prevValue])
...
function setAreKeyboardFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areKeyboardFieldsAdditionalMapFocused: areKeyboardFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areKeyboardFieldsAdditionalMapFocusedClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areKeyboardFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
        : areKeyboardFieldsAdditionalMapFocusedClone.set(index, [prevKey, data]);
...
function setAreKeyboardFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areKeyboardFieldsAdditionalMapValid: areKeyboardFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areKeyboardFieldsAdditionalMapValidClone = structuredClone(
      ...
      return {
        ...state,
        areKeyboardFieldsAdditionalMapValid: filteredAreKeyboardFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areKeyboardFieldsAdditionalMapValidClone = structuredClone(
...
function setAreRamFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      return {
        ...state,
        areRamFieldsAdditionalMapFocused: filteredAreRamFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const areRamFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreMicrophoneFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "update": {
      ...
      const { data, index, kind } = action.payload as AdditionalFieldsValidFocusedUpdate;
      const prevKeyVal = areMicrophoneFieldsAdditionalMapFocusedClone.get(index);
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areMicrophoneFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
        : areMicrophoneFieldsAdditionalMapFocusedClone.set(index, [prevKey, data]);
...
function setAreMicrophoneFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areMicrophoneFieldsAdditionalMapValid: areMicrophoneFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areMicrophoneFieldsAdditionalMapValidClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areMicrophoneFieldsAdditionalMapValidClone.set(index, [data, prevValue])
        : areMicrophoneFieldsAdditionalMapValidClone.set(index, [prevKey, data]);
...
function setAreMotherboardFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      Array.from(areMotherboardFieldsAdditionalMapFocusedClone).forEach(
        (mapIdxKeyVal, arrayIdx) => {
          ...
          filteredAreMotherboardFieldsAdditionalMapFocused.set(arrayIdx, keyVal);
        }
      );
    ...
    case "update": {
      ...
      const { data, index, kind } = action.payload as AdditionalFieldsValidFocusedUpdate;
      const prevKeyVal = areMotherboardFieldsAdditionalMapFocusedClone.get(index);
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areMotherboardFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
        : areMotherboardFieldsAdditionalMapFocusedClone.set(index, [prevKey, data]);
...
function setAreMotherboardFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areMotherboardFieldsAdditionalMapValidClone.set(index, [data, prevValue])
        : areMotherboardFieldsAdditionalMapValidClone.set(index, [prevKey, data]);
...
function setAreMouseFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areMouseFieldsAdditionalMapFocused: areMouseFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areMouseFieldsAdditionalMapFocusedClone = structuredClone(
      ...
      return {
        ...state,
        areMouseFieldsAdditionalMapFocused: filteredAreMouseFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const areMouseFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreMouseFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      return {
        ...state,
        areMouseFieldsAdditionalMapValid: filteredAreMouseFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areMouseFieldsAdditionalMapValidClone = structuredClone(
...
function setArePsuFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "remove": {
      ...
      return {
        ...state,
        arePsuFieldsAdditionalMapFocused: filteredArePsuFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const arePsuFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreSmartphoneFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    ...
    case "update": {
      ...
      const { data, index, kind } = action.payload as AdditionalFieldsValidFocusedUpdate;
      const prevKeyVal = areSmartphoneFieldsAdditionalMapFocusedClone.get(index);
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areSmartphoneFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
        : areSmartphoneFieldsAdditionalMapFocusedClone.set(index, [prevKey, data]);
...
function setAreSmartphoneFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areSmartphoneFieldsAdditionalMapValid: areSmartphoneFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areSmartphoneFieldsAdditionalMapValidClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areSmartphoneFieldsAdditionalMapValidClone.set(index, [data, prevValue])
        : areSmartphoneFieldsAdditionalMapValidClone.set(index, [prevKey, data]);
...
function setAreSpeakerFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areSpeakerFieldsAdditionalMapFocused: areSpeakerFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areSpeakerFieldsAdditionalMapFocusedClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areSpeakerFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
...
function setAreSpeakerFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areSpeakerFieldsAdditionalMapValid: areSpeakerFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areSpeakerFieldsAdditionalMapValidClone = structuredClone(
      ...
      return {
        ...state,
        areSpeakerFieldsAdditionalMapValid: filteredAreSpeakerFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areSpeakerFieldsAdditionalMapValidClone = structuredClone(
...
function setAreStorageFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areStorageFieldsAdditionalMapFocused: areStorageFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areStorageFieldsAdditionalMapFocusedClone = structuredClone(
    ...
    case "update": {
      ...
      const [prevKey, prevValue] = prevKeyVal;
      kind === "key"
        ? areStorageFieldsAdditionalMapFocusedClone.set(index, [data, prevValue])
...
function setAreStorageFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areStorageFieldsAdditionalMapValid: areStorageFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areStorageFieldsAdditionalMapValidClone = structuredClone(
      ...
      return {
        ...state,
        areStorageFieldsAdditionalMapValid: filteredAreStorageFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areStorageFieldsAdditionalMapValidClone = structuredClone(
...
function setAreTabletFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areTabletFieldsAdditionalMapFocused: areTabletFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areTabletFieldsAdditionalMapFocusedClone = structuredClone(
      ...
      return {
        ...state,
        areTabletFieldsAdditionalMapFocused: filteredAreTabletFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const areTabletFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreTabletFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areTabletFieldsAdditionalMapValid: areTabletFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areTabletFieldsAdditionalMapValidClone = structuredClone(
      ...
      return {
        ...state,
        areTabletFieldsAdditionalMapValid: filteredAreTabletFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areTabletFieldsAdditionalMapValidClone = structuredClone(
...
function setAreWebcamFieldsAdditionalMapFocused_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areWebcamFieldsAdditionalMapFocused: areWebcamFieldsAdditionalMapFocusedClone,
      };
    }
    case "remove": {
      const areWebcamFieldsAdditionalMapFocusedClone = structuredClone(
      ...
      return {
        ...state,
        areWebcamFieldsAdditionalMapFocused: filteredAreWebcamFieldsAdditionalMapFocused,
      };
    }
    case "update": {
      const areWebcamFieldsAdditionalMapFocusedClone = structuredClone(
...
function setAreWebcamFieldsAdditionalMapValid_CreateProductReducer(
  ...
  switch (operation) {
    case "add": {
      ...
      return {
        ...state,
        areWebcamFieldsAdditionalMapValid: areWebcamFieldsAdditionalMapValidClone,
      };
    }
    case "remove": {
      const areWebcamFieldsAdditionalMapValidClone = structuredClone(
      ...
      return {
        ...state,
        areWebcamFieldsAdditionalMapValid: filteredAreWebcamFieldsAdditionalMapValid,
      };
    }
    case "update": {
      const areWebcamFieldsAdditionalMapValidClone = structuredClone(
...
const createProductReducersMap = new Map<
  ...
  (state: CreateProductState, action: CreateProductDispatch) => CreateProductState
>([
  // ╔═════════════════════════════════════════════════════════════════╗
  ...
  [createProductAction.setIsBrandFocused, setIsBrandFocused_CreateProductReducer],
  // model
  ...
  [createProductAction.setIsModelFocused, setIsModelFocused_CreateProductReducer],
  // description
  [createProductAction.setDescription, setDescription_CreateProductReducer],
  [createProductAction.setIsDescriptionValid, setIsDescriptionValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsPriceFocused, setIsPriceFocused_CreateProductReducer],
  // currency
  ...
  [createProductAction.setIsQuantityValid, setIsQuantityValid_CreateProductReducer],
  [createProductAction.setIsQuantityFocused, setIsQuantityFocused_CreateProductReducer],
  // weight
  ...
  [createProductAction.setIsWeightFocused, setIsWeightFocused_CreateProductReducer],
  // weight unit
  ...
  [createProductAction.setIsCpuSocketValid, setIsCpuSocketValid_CreateProductReducer],
  [createProductAction.setIsCpuSocketFocused, setIsCpuSocketFocused_CreateProductReducer],
  // cpu -> frequency
  ...
  [createProductAction.setIsCpuCoresValid, setIsCpuCoresValid_CreateProductReducer],
  [createProductAction.setIsCpuCoresFocused, setIsCpuCoresFocused_CreateProductReducer],
  ...
  [createProductAction.setIsCpuWattageValid, setIsCpuWattageValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsCaseColorValid, setIsCaseColorValid_CreateProductReducer],
  [createProductAction.setIsCaseColorFocused, setIsCaseColorFocused_CreateProductReducer],
  // case -> side panel
  ...
  [createProductAction.setIsDisplaySizeValid, setIsDisplaySizeValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsGpuChipsetValid, setIsGpuChipsetValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsGpuTdpFocused, setIsGpuTdpFocused_CreateProductReducer],
  // gpu -> additional fields
  [
  ...
  [createProductAction.setIsMouseDpiValid, setIsMouseDpiValid_CreateProductReducer],
  [createProductAction.setIsMouseDpiFocused, setIsMouseDpiFocused_CreateProductReducer],
  // mouse -> buttons
  ...
  [createProductAction.setIsMouseColorValid, setIsMouseColorValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsPsuWattageValid, setIsPsuWattageValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsRamDataRateValid, setIsRamDataRateValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsRamColorValid, setIsRamColorValid_CreateProductReducer],
  [createProductAction.setIsRamColorFocused, setIsRamColorFocused_CreateProductReducer],
  // ram -> voltage
  [createProductAction.setRamVoltage, setRamVoltage_CreateProductReducer],
  [createProductAction.setIsRamVoltageValid, setIsRamVoltageValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsRamTimingValid, setIsRamTimingValid_CreateProductReducer],
  [createProductAction.setIsRamTimingFocused, setIsRamTimingFocused_CreateProductReducer],
  // ram -> additional fields
  [
  ...
  [createProductAction.setIsTabletColorValid, setIsTabletColorValid_CreateProductReducer],
  [
  ...
  [createProductAction.setIsWebcamColorValid, setIsWebcamColorValid_CreateProductReducer],
  [
  ...
  // images -> valid
  [createProductAction.setAreImagesValid, setAreImagesValid_CreateProductReducer],
  ...
  // success message
  [createProductAction.setSuccessMessage, setSuccessMessage_CreateProductReducer],
]);
