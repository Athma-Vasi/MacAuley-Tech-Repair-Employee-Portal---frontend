...
const announcementsArray: AnnouncementsArray = [
...

  {
    ...
    bannerImageAlt: "Woman and a Man Presenting Image on a Laptop Screen to a Dog",
    ratingResponse: {
      ratingEmotion: {
        estatic: 40,
        happy: 50,
...

  {
    ...
    bannerImageAlt: "Composition of calculator with paper money and notebook with pen",
    ratingResponse: {
      ratingEmotion: {
        estatic: 25,
        happy: 65,
