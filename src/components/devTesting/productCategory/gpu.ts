...
const GPUS_ARRAY: (ProductCategorySpecifications & GpuSpecifications)[] = [
  {
    brand: 'NVIDIA',
...
function returnGpuSchemas({
  gpusArray,
  usersDocs,
}: {
  usersDocs: DirectoryUserDocument[];
  gpusArray: typeof GPUS_ARRAY;
}) {
...
const GPU_DOCUMENTS = [
  {
    ...
    reviewsIds: [],
    uploadedFilesIds: [],
    createdAt: '2023-11-25T05:51:10.853Z',
    updatedAt: '2023-11-25T05:51:10.853Z',
    fileUploads: [],
  },
  {
    _id: '65618b4e9ef8ecb7967f5832',
