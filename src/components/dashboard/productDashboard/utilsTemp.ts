...
async function returnProductMetricsCharts2({
  businessMetrics,
  months,
  selectedProductCategory,
  selectedDateProductMetrics,
  ...
  return {
    daily: dailyProductCharts,
    monthly: monthlyProductCharts,
    yearly: yearlyProductCharts,
  };
}
...
async function createDailyProductCharts({
  ...
  selectedDayMetrics,
  selectedYear,
}: CreateDailyProductChartsInput): Promise<ProductMetricsCharts["daily"]> {
  ...
  return new Promise<ProductMetricsCharts["daily"]>((resolve) => {
    setTimeout(() => {
      const [
...
function createMonthlyProductCharts({
  ...
  selectedMonthMetrics,
  selectedYear,
}: CreateMonthlyProductChartsInput): Promise<ProductMetricsCharts["monthly"]> {
  ...
  return new Promise<ProductMetricsCharts["monthly"]>((resolve) => {
    setTimeout(() => {
      const [
...
function createYearlyProductCharts({
  ...
  selectedYearMetrics,
  yearlyMetrics,
}: CreateYearlyProductChartsInput): Promise<ProductMetricsCharts["yearly"]> {
  ...
  return new Promise<ProductMetricsCharts["yearly"]>((resolve) => {
    setTimeout(() => {
      const [
